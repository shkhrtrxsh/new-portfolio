    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          I’m Shikhar Mishra, a passionate Frontend Developer with 3 years of
          experience building intuitive and responsive web applications. I
          specialize in crafting dynamic user interfaces using React.js,
          Next.js, and React Native, focusing on delivering seamless user
          experiences across devices. I thrive in fast-paced environments and
          have contributed to innovative projects, including automating
          incentive calculations for Domino’s India and building an insurance
          quotation system for Yonna Islamic Microfinance. My expertise extends
          to full-stack development with Node.js, Express, and MongoDB, and I’ve
          successfully deployed solutions on AWS. When I’m not coding, you’ll
          find me exploring emerging web technologies or refining my skills to
